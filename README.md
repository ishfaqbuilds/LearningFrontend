...
| Date | Practice | What I Learned | What I Used in the Practice |
|---|---|---|---|
| 07/09/2026 | Profile Card | CSS selectors, Google Fonts, Flexbox, `width`, `height`, `max-width`, `padding`, `margin`, `border`, `border-radius`, `box-shadow`, `background-color`, `color`, `font-size`, `font-weight`, `position`, `object-fit`, `display`, `align-items`, `justify-content`, `gap` | Created a profile card with a cover image, profile image, profile information, Follow button, and follower statistics while practicing Flexbox and basic CSS styling. |
